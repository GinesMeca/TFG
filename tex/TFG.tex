...
\begin{figure}[h]
\centering
\includegraphics[width = 0.5\textwidth]{ex2_2_01}
...
\begin{figure}[H]
\centering
\includegraphics[width = 0.35\textwidth]{AdaBoost_03}
...
\begin{figure}[H]
\centering
\includegraphics[width = 0.4\textwidth]{GB_01}
...
\textit{Al igual que en los ejemplos anteriores, calcularemos el coeficiente de Gini haciendo uso del AUC para elegir los modelos más precisos y realizar correctamente las comparaciones. Así, los resultados de los diferentes algoritmos son:}
