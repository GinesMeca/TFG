...
\begin{figure}[h]
\centering
\includegraphics[width = \textwidth]{ex3_1_02}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.25 \textwidth]{CatBoost_03}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.7 \textwidth]{CatBoost_06}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.6\textwidth]{ex_boost_02}
\end{figure}
