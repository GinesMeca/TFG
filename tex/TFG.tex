...
\hline
\cellcolor[HTML]{C0C0C0}Algoritmo & \cellcolor[HTML]{C0C0C0}Metodología & \cellcolor[HTML]{C0C0C0} Implementación Python & \cellcolor[HTML]{C0C0C0}Parámetros & \cellcolor[HTML]{C0C0C0}Control \textit{Overfitting} & \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}l@{}}Coste \\ Computacional\end{tabular} & \cellcolor[HTML]{C0C0C0}Consideraciones \\ \hline
CART                              & Simple                              & \begin{tabular}[c]{@{}l@{}} Scikit-Learn: \\ - DecisionTreeRegressor \\ - DecisionTreeClassifier\end{tabular}                                                                   &                                     & Disminución de la profundidad máxima                                                                                                                & Bajo                                                                                       & \begin{tabular}[c]{@{}l@{}}- Exploración inicial de datos \\ - Método sencillo \\ - Admite representación gráfica \\ - Inestable \end{tabular}                                         \\ \hline
Bagging                           & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - BaggingRegressor \\ - BaggingClassifier \end{tabular}                                                                             &                                    & \begin{tabular}[c]{@{}l@{}} Disminución de la profundidad máxima de \\ los árboles generados \end{tabular}                                                                                                                  & Alto  & \begin{tabular}[c]{@{}l@{}}- Uso de todas las variables explicativas \\ disponibles \\ - Convergencia del error\end{tabular}                                                                                                                              \\ \hline
Random Forest                     & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - RandomForestRegressor \\ - RandomForestClassifier \end{tabular}                                                                             & $m$                                    & \begin{tabular}[c]{@{}l@{}} Disminución de la profundidad máxima de \\ los árboles generados \end{tabular}                                                                                                                                                                                                                                                                                                                                                    & Medio                                                                                        & \begin{tabular}[c]{@{}l@{}}- Cada árbol utiliza $m$ variables \\ - Disminución de la varianza \\ - Convergencia del error \end{tabular}                                                                                                                                                                      \\ \hline
Extra-Trees                       & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - ExtraTreesRegressor \\ - ExtraTreesClassifier \end{tabular}                                                                             & $m$                                    & \begin{tabular}[c]{@{}l@{}} Disminución de la profundidad máxima de \\ los árboles generados \end{tabular}                                                                                                                  & Medio                                                                                        & \begin{tabular}[c]{@{}l@{}}- Mayor aleatoriedad \\ - Útil ante problemas de \textit{overfitting} extremos \\ - Convergencia del error \end{tabular}                                                                                                                     \\ \hline
AdaBoost                          & Boosting                            & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - AdaBoostRegressor \\ - AdaBoostClassifier \end{tabular}                                                                             &                                    & Número de iteraciones                                                                                                                 & Medio                                                                                        & \begin{tabular}[c]{@{}l@{}}- Construcción de cadenas de árboles \\ que reducen secuencialmente el error \\ - Generación de árboles de dos nodos hoja \end{tabular}                                                                                                                     \\ \hline
Gradient Boosting                 & Boosting                            & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - GradientBoostingRegressor \\ - GradientBoostingClassifier \end{tabular}                                                                             & $\nu$                                    & \begin{tabular}[c]{@{}l@{}}- Disminución de la tasa de aprendizaje ($\nu$) \\ - Disminución del número de iteraciones \end{tabular}                                                                                                                                                                                             & Alto                                                                                       & \begin{tabular}[c]{@{}l@{}}- Construcción de cadenas de árboles \\ que reducen secuencialmente el error \\ - Suele aplicarse con un elevado \\ número de iteraciones \end{tabular}                                                                                                                                                            \\ \hline
XGBoost                           & Boosting                            & \begin{tabular}[c]{@{}l@{}}XGBoost: \\ - XGBRegressor \\ - XGBClassifier \end{tabular}                                                                             & \begin{tabular}[c]{@{}l@{}} - $\eta$ \\ - $\lambda$ \\ - $\gamma$ \end{tabular}                                                                                                                & \begin{tabular}[c]{@{}l@{}}- Disminución de la tasa de aprendizaje ($\eta$) \\ - Aumento de alguno de los parámetros de \\ regularización $\lambda$ y $\gamma$ \end{tabular}                                                                                                                                                                                             & Medio                                                                                       & \begin{tabular}[c]{@{}l@{}}- Construcción de cadenas de árboles \\ que reducen secuencialmente el error \\ - Suele aplicarse con un elevado \\ número de iteraciones \\ - Inclusión de parámetros de regularización \\ - Escisión de nodos a través de percentiles \\ - Autoregularización mediante \textit{early-stopping} \\ - Capacidad de trabajar con \textit{null values} \end{tabular}                                                                                                                                                                                                     \\ \hline
LightGBM                          & Boosting                            & \begin{tabular}[c]{@{}l@{}}LightGBM: \\ - LGBMRegressor \\ - LGBMClassifier \end{tabular} & \begin{tabular}[c]{@{}l@{}} - $\eta$ \\ - $\lambda$ \\ - $\gamma$ \end{tabular}                                                                                                                                                  & \begin{tabular}[c]{@{}l@{}}- Disminución de la tasa de aprendizaje ($\eta$) \\ - Aumento de alguno de los parámetros de \\ regularización $\lambda$ y $\gamma$ \end{tabular}                                                                                                                                                                                                                                                                                                            & Bajo                                                                                        & \begin{tabular}[c]{@{}l@{}}- Construcción de cadenas de árboles \\ que reducen secuencialmente el error \\ - Suele aplicarse con un elevado \\ número de iteraciones \\ - Inclusión de parámetros de regularización \\ - Escisión de nodos a través de percentiles \\ - Autoregularización mediante \textit{early-stopping} \\ - Capacidad de trabajar con \textit{null values} \\ - Árboles que maximizan la ganancia \\ nodo a nodo \end{tabular}                                                                                                                                                                                                                                            \\ \hline
CatBoost                          & Boosting                            & \begin{tabular}[c]{@{}l@{}}CatBoost: \\ - CatBoostRegressor \\ - CatBoostClassifier \end{tabular} & \begin{tabular}[c]{@{}l@{}} - $\eta$ \\ - $\lambda$ \\ - $\gamma$ \end{tabular}                                                                                                                                                                                    & \begin{tabular}[c]{@{}l@{}}- Disminución de la tasa de aprendizaje ($\eta$) \\ - Aumento de alguno de los parámetros de \\ regularización $\lambda$ y $\gamma$ \end{tabular}                                                                                                                                                                                                                                                                                                                                                                                                                           & Bajo                                                                                       & \begin{tabular}[c]{@{}l@{}}- Construcción de cadenas de árboles \\ que reducen secuencialmente el error \\ - Suele aplicarse con un elevado \\ número de iteraciones \\ - Inclusión de parámetros de regularización \\ - Escisión de nodos a través de percentiles \\ - Autoregularización mediante \textit{early-stopping} \\ - Capacidad de trabajar con \textit{null values} \\ - Codificación de las variables categóricas \\ sin utilizar \textit{one-hot-encoding} \\ - Generación de árboles simétricos \end{tabular}                                                                                                                                                                                                                                                                                   \\ \hline
\end{tabular}
}
\end{table}
