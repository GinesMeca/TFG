...
\begin{table}[h]
\centering
\includegraphics[width = 0.4 \textwidth]{CatBoost_03}
...
\begin{figure}[h]
\centering
\includegraphics[width = 0.8 \textwidth]{CatBoost_06}
...
Bagging                           & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - BaggingRegressor \\ - BaggingClassifier \end{tabular}                                                                             & \begin{tabular}[c]{@{}l@{}} - \textit{n\_estimators}: Número de árboles \\ - \textit{oob\_score}: Devuelve el error OOB del modelo \\ - \textit{bootstrap}: Decide si las muestras se toman con \\ repetición o no     \end{tabular}                               & \begin{tabular}[c]{@{}l@{}} Control del \textit{overfitting} de los árboles generados \\ mediante alguna de las técnicas anteriores \end{tabular}                                                                                                                  & Medio-Alto  & \begin{tabular}[c]{@{}l@{}}- Uso de todas las variables explicativas disponibles \\ - Convergencia del error\end{tabular}                                                                                                                              \\ \hline
Random Forest                     & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - RandomForestRegressor \\ - RandomForestClassifier \end{tabular}                                                                             & \begin{tabular}[c]{@{}l@{}} - \textit{n\_estimators} \\ - \textit{oob\_score} \\ - \textit{bootstrap} \\ - $m$: Número de variables que participan en la \\ construcción de cada árbol \end{tabular}                                                                                                                                                                                          & \begin{tabular}[c]{@{}l@{}} - Control del \textit{overfitting} de los árboles generados \\ mediante alguna de las técnicas anteriores \\ - Disminución de $m$ \end{tabular}                                                                                                                                                                                                                                                                                                                                                    & Medio-Bajo                                                                                        & \begin{tabular}[c]{@{}l@{}}- Cada árbol utiliza $m$ variables \\ - Disminución de la varianza \\ - Convergencia del error \end{tabular}                                                                                                                                                                      \\ \hline
Extra-Trees                       & Bagging                             & \begin{tabular}[c]{@{}l@{}}Scikit-Learn: \\ - ExtraTreesRegressor \\ - ExtraTreesClassifier \end{tabular}                                                                             & \begin{tabular}[c]{@{}l@{}} - \textit{n\_estimators} \\ - \textit{oob\_score} \\ - \textit{bootstrap} \\ - $m$ \end{tabular}                                                                                                                                                       & \begin{tabular}[c]{@{}l@{}} - Control del \textit{overfitting} de los árboles generados \\ mediante alguna de las técnicas anteriores \\ - Disminución de $m$ \end{tabular}                                                                                                                  & Medio-Bajo                                                                                        & \begin{tabular}[c]{@{}l@{}}- Mayor aleatoriedad \\ - Útil ante problemas de \textit{overfitting} extremos \\ - Convergencia del error \\ - Cada árbol utiliza $m$ variables y solo chequea un valor por variable \\ para escindir nodos \end{tabular}                                                                                                                     \\ \hline
\end{tabular}
}
\end{turn}
...
CatBoost                          & Boosting                            & \begin{tabular}[c]{@{}l@{}}CatBoost: \\ - CatBoostRegressor \\ - CatBoostClassifier \end{tabular} & Mismos que XGBoost & Equivalente a XGBoost & Medio                                                                                       & \begin{tabular}[c]{@{}l@{}}- Misma base que XGBoost \\ - Codificación de las variables categóricas sin utilizar \textit{one-hot-encoding} \\ - Generación de árboles simétricos \end{tabular}                                                                                                                                                                                                                                                                                   \\ \hline
\end{tabular}
}
\end{turn}
